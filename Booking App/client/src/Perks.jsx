    ...
    return (
        <>
            <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer'>
                ...
                name="wifi" onChange={ handleCbClick} />
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' >
                ...
                name="parking" onChange={ handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' >
                ...
                name="tv"  onChange={ handleCbClick}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' >
                ...
                name="radio" onChange={ handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' >
                ...
                name="pets" onChange={ handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <label className='border p-4 flex rounded-2xl gap-2 items-center cursor-pointer' >
                ...
                name="entrance" onChange={ handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
